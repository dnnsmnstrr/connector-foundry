...
joint (see "Joints") builds on; an Outie that is simply fused onto something can take
`fill_holes: true` to plug its three holes solid instead of printing them as dead space. Any other
Mechanism part — or a Printables model — comes in
